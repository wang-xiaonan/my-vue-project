          ...
          <div class="rating-wrapper">
            <ul v-show="food.ratings && food.ratings.length">
              <li v-show="needShow(rating.rateType,rating.text)" v-for="rating in food.ratings"
                ...
                <p class="text">
                  <span :class="{'st-thumb_up':rating.rateType===0,'st-thumb_down':rating.rateType===1}"></span>{{rating.text}}
                </p>
              </li>
            </ul>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      addFirst (e) {
        this.$root.eventsHub.$emit('cart.add', e.target)
