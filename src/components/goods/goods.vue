<template>
  <div>
    <div class="goods">
      ...
      <shoppingcart ref="shoppingCart" :selectFoods="selectFoods" :deliveryPrice="seller.deliveryPrice" :minPrice="seller.minPrice"></shoppingcart>
    </div>
...
<script>
  ...
  export default {
    ...
    created () {
      ...
      // 2.0 去掉了events，参考
      this.$root.eventsHub.$on('cart.add', (e) => {
        this.dropBall(e)
      })
    },
    methods: {
